...
- **Pulang → weekday kembali (locked 2026-08-12):** saat user pilih `pulang`, jadwal weekend miliknya dihapus, lalu `restoreWeekdayForMember` mengisi ulang hari piket (Sen/Rab/Jum) yang **kosong di MINGGU BERJALAN saja** (bukan seluruh bulan) dengan member ini — mengembalikan weekday yang dihapus saat di_kos.
